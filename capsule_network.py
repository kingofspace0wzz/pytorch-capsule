...
class CapsuleNetwork(nn.Module):
    def __init__(self,
        ...
        self.reconstruct0 = nn.Linear(int(num_output_units*output_unit_size), int((reconstruction_size * 2) / 3))
        self.reconstruct1 = nn.Linear(int((reconstruction_size * 2) / 3), int((reconstruction_size * 3) / 2))
        self.reconstruct2 = nn.Linear(int((reconstruction_size * 3) / 2), int(reconstruction_size))
